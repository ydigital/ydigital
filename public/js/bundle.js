...
var _ScrollToPlugin = __webpack_require__(6);
...
menu.onclick = function () {
	...
	_gsap.TweenMax.staggerFrom('.menu-item', .3, { scale: 0.5, opacity: 0, delay: .5, color: '#edbf29' }, .1);
...
arrowLego.addEventListener('click', function () {
	_gsap.TweenMax.to(window, 1, { scrollTo: '#tiles', ease: Circ.easeOut });
});
...
overlayShow.addEventListener('click', function () {
	menuWrapper.classList.remove('menu-wrapper-show');
...
var tileTopOffset = document.getElementById('tiles').offsetTop;

var nm1 = document.getElementById('fct-nmb-1');
var nm2 = document.getElementById('fct-nmb-2');
var nm3 = document.getElementById('fct-nmb-3');
var nm4 = document.getElementById('fct-nmb-4');
var nm5 = document.getElementById('fct-nmb-5');
var nm6 = document.getElementById('fct-nmb-6');
var options = {
	useEasing: true,
	useGrouping: true,
	separator: ',',
...
var demo1 = new CountUp(nm1, 0, 3, 0, 2.5, options);
var demo2 = new CountUp(nm2, 0, 12483303, 0, 2.5, options);
var demo3 = new CountUp(nm3, 0, 45, 0, 2.5, options);
var demo4 = new CountUp(nm4, 0, 100, 0, 2.5, options);
var demo5 = new CountUp(nm5, 0, 0, 0, 2.5, options);
var demo6 = new CountUp(nm6, 0, 100, 0, 2.5, options);
